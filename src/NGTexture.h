...
public:
    ...
    virtual void Generate_WorleyNoise(int iPoints, const char* szColorFunc, const char* szDistanceFunc, float fNoiseIntensity) = 0;
    virtual void Generate_ReactionDiffusion(int iIterations, int iSpawnPoints, float fNoiseIntensity) = 0;
...
public:
    ...
    virtual void Generate_WorleyNoise(int iPoints, const char* szColorFunc, const char* szDistanceFunc, float fNoiseIntensity);
    virtual void Generate_ReactionDiffusion(int iIterations, int iSpawnPoints, float fNoiseIntensity);
